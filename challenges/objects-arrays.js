...
console.log(tyrannosaurus.weight); //7000 kg
// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic
...
//                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              RAWEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE; // 
...
const graduates = [{"ID":1, "first_name":"Cynde", "university": 'Missouri Southern State College", "email": c'},
...
for ( i = 0; i < graduates.length; i++) {
  ...
  contactInfo.push('$graduated[i].first_name} ${graduates[i].email}');
  }
